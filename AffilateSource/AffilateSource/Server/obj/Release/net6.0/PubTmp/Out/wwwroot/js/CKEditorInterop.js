window.CKEditorInterop = (() => {
    const editors = {};
    let uploadToUrl = 'https://localhost:44332/api/q/Upload';
    ...
    class MyUploadAdapter {
        ...
        _initListeners(resolve, reject, file) {
            ...
            xhr.addEventListener('load', () => {
                ...
                var _urlImages = "https://" + window.location.hostname + (window.location.port ? ':' + window.location.port : '') + "/uploads/editors/img/" + response;
